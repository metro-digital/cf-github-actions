...
async function run() {
  try {
    ...
    if (mode == "remove") {
      core.info("Skipping cleanup. Authorized network was already removed by main action.")
      return
    }
    ...
    updateCluster(client, projectId, location, clusterName, "remove", description, ip)
  } catch (e) {
    core.setFailed(e)
  }
}
